"""
Django settings for nnnn_43152 project.
...
WSGI_APPLICATION = 'nnnn_43152.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nnnn_43152 API",
    "DESCRIPTION": "API documentation for nnnn_43152 App",
    "VERSION": "v1",
}
